    ...
    async def get_news_summaries(self, args: str) -> str:
        ...
        try:
            ...
            def sync_news_query():
                ...
                #         the _select_news_categories_llm call before run_in_executor). The old keyword
                #         classifier (find_categories_ranked/find_keyword_sources/ENHANCED_CATEGORY_MAPPING)
                #         was DELETED in v1.0.0.143.
