...
echo "$SUDO_PASS" | sudo -S mysql <<EOF
...
APP_TIMEZONE=UTC
APP_KEY=base64_test_key_12345678901234567890123456789012

# Database
DB_CONNECTION=mysql
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=user_profiles_test
...
# Security
CSRF_TOKEN_SECRET=csrf_secret_key_for_testing_only_change_in_prod
BCRYPT_ROUNDS=10
...
echo "Step 5: Testing database connection and creating test user..."
php -r "
